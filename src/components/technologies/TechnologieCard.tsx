  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border border-gray-100">
      <div>
        ...
        <p className="text-gray-600 mt-1 leading-6">{technology.description}</p>
      </div>
      ...
      <div className="mt-4 flex justify-between items-center">
        ...
        <p className="text-sm text-gray-500">{technology.difficulty}</p>

        <p className="font-semibold text-gray-800">⭐ {technology.rating}</p>
      </div>
      ...
      <div className="flex justify-center">
        <button
          ...
          disabled={isSelected}
          className={`mt-4 w-full text-white font-bold py-2 px-4 rounded-lg 
